...
const secCands = [
    { name: "Camila Lima", src: "/images/Camila.jpeg", bio: "My key motivations for running in this election is that I want to be involved and make sure everyone's voice is heard as we enter our senior year. My goal is to have an enjoyable year that accommodates everyone's needs financial-wise and distance-wise when planning events.", socials: "insta - @probablycamila" },
